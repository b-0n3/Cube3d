...
typedef struct		s_image{
	...
	void			(*put_pixel)(t_window v, int x,
		int y, int color);
}					t_image;
...
void				render_sprite_texture(double p[],
	double wall_hei, t_sp_texture *tex, double dis);
...
void				cast_sprite(t_vector *pos, t_sprites *sp,
	t_ray_sp **ray_sp, t_ray *ray);
void				render_wall_texture(double p[], double wall_hei,
	t_texture *tex, double dis);
#endif
